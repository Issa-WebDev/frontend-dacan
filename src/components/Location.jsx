  ...
  return (
    <section className="relative overflow-hidden text-center text-white py-20 px-4">
      ...
      <div className="max-w-7xl mx-auto bg-gray-100 rounded-lg shadow-lg overflow-hidden">
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m12!1m8!1m3!1d31776.693333590647!2d-3.9675236!3d5.4037676!3m2!1i1024!2i768!4f13.1!2m1!1sCocody%20Angr%C3%A9%20Djorogobit%C3%A9%20en%20face%20de%20la%20base%20CIE%20Lot%201191%20Ilot%20120%203%20Abidjan!5e0!3m2!1sfr!2sci!4v1745587636317!5m2!1sfr!2sci"
          width="100%"
          height="350"
          style={{ border: "0" }}
          allowFullScreen=""
